...
font_subtitles = font.SysFont('Corbel', 35, True) # третий параметр True означает что шрифт будет жирным
...
heal = mixer.Sound('heal.ogg')
collide = mixer.Sound('collide.ogg')
...
img_healthpack = "healthpack.png"  # аптечка
